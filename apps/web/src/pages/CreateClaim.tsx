                  ...
                  <div className="relative">
                    ...
                    {accountEvm && (
                      <button
                        ...
                        className="mt-2 w-full inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-primary/10 border border-primary/25 text-[11px] font-mono text-primary hover:bg-primary/20 transition-colors"
                        title="Use connected wallet address"
                      >
                        <Wallet className="w-3 h-3" />
                        Use connected wallet {formatAddress(accountEvm)}
                      </button>
                    )}
                  </div>
                </div>
