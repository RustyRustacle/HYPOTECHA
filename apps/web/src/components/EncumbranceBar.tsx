      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between gap-4 mb-5">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <span className="inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-black/25 px-2.5 py-1.5 font-mono text-xs text-text-secondary">
              <CircleDot className="w-3 h-3 text-primary" />
              {formatCurrency(asset.unitUsd)}
            </span>
            {onPledge && (
              <button
                onClick={onPledge}
                className="liquid-glass liquid-cta liquid-glass-button px-4 py-2 rounded-xl text-xs font-semibold flex items-center gap-1.5"
              >
